...
\newcommand{\thiscoursecode}{ph2a}
\newcommand{\thiscoursename}{Vibrations and Waves}
\newcommand{\thisprof}{Prof. Rana X Adhikari}
\newcommand{\me}{}
\newcommand{\thisterm}{Fall 2017}
\newcommand{\website}{https://piazza.com/caltech/fall2017/ph2a/home}
...
{\large{\noun{Vibrations and Waves}}}\\ \vspace{0.1in}
...
\doabstract{These notes are intended to be a summary of the lectures 
  in the Caltech course ph2a:
  Vibrations and Waves, from the Fall of 2017. For this course, we
  used the textbook
  ``Vibrations and Waves'', by A.P. French,
  so the topics follow the notation and logic 
  presented therein.
  If you notice any mistakes, please contact me directly.}

\clearpage
\input{HarmonicOscillators}
